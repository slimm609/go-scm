...
func ExampleReference_findBranch() {
	client, err := github.New("https://api.github.com")
	if err != nil {
		log.Fatal(err)
	}
...
func ExampleReference_listBranch() {
	client, err := github.New("https://api.github.com")
	if err != nil {
		log.Fatal(err)
	}
...
func ExampleCommit_listOnBranch() {
	client, err := github.New("https://api.github.com")
	if err != nil {
		log.Fatal(err)
	}
